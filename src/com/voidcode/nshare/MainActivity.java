...
public class MainActivity extends Activity  {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		tvMainUrl.setMovementMethod(new ScrollingMovementMethod());
	...
	public void tvMainUrlOnClicked(View v)
	{
		Toast.makeText(v.getContext(), "trMainUrlOnClicked", Toast.LENGTH_SHORT).show();
	}
	...
	public void lvMainDeviecOnclickAndLongClickListenter()
	{
		...
		lvMainDevices.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parnet, View v, int pos, long id) {
				...
				else if((numOfSelectDeviceItems > 0) && stackOfToIPs.contains(deviceItems.get(pos).getIp()))
				{
